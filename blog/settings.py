...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/gokhan/deneme3/blog/mydata.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join('/home/gokhan/deneme3/blog/uploads')

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://example.com/media/", "http://media.example.com/"
MEDIA_URL = '/uploads/'
CKEDITOR_UPLOAD_PATH = os.path.join('/home/gokhan/deneme3/blog/uploads/editor')
